...
👋 Hi, I’m Eren! As a developer who has been working in the field of data science for many years, I now aim to pivot my career towards Quantum Computing. In this repository, I aim to share the work I have done throughout my PhD and publish my developments. In this way, my work will be easier to follow and more traceable.

👀 I’m interested in Quantum Computing and Quantum Physics topics. 
...
- **Python** 🐍: Proficient in advanced Python, specializing in quantum computing libraries:
  - **Qiskit**
  - **TensorFlow Quantum**
...
- **Quantum Fourier Transform (QFT)** & **Quantum Phase Estimation (QPE)** 🌀
